...
void set_verity_enabled_state_service(int fd, void* cookie) {
    ...
    if (!using_avb) {
        ...
        if (!android::base::GetBoolProperty("ro.secure", false)&&!android::base::GetBoolProperty("ro.factory_mode", true)) {//+bug336856,xiongchao.wt,add,20180303,add,add ro.factory_mode condition 
