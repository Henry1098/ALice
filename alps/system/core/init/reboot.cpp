...
static UmountStat TryUmountAndFsck(bool runFsck, std::chrono::milliseconds timeout) {
    ...
    std::vector<MountEntry> block_devices;
    std::vector<MountEntry> emulated_devices;
    /*bug 340948,zhaodonghong.wt, optimize shutdown time,20180411,start */
    //TurnOffBacklight();  // this part can take time. save power.
    /*bug 340948,zhaodonghong.wt, optimize shutdown time,20180411,end */
...
void DoReboot(unsigned int cmd, const std::string& reason, const std::string& rebootTarget,
   ...
   /*bug 340948,zhaodonghong.wt, optimize shutdown time,20180411,end */
    ...
    //sync();
    /*bug 340948,zhaodonghong.wt, debug  shutdown time,20180411,start */
    {
        Timer sync_timer;
    ...
    //sync();
   {
     ...
     /*bug 340948,zhaodonghong.wt, debug  shutdown time,20180411,end */
