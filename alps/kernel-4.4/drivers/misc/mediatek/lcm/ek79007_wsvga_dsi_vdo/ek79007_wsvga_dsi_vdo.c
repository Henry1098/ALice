...
#define LCM_DSI_CMD_MODE  0
	...
	{
#ifndef BUILD_LK
		lcm_set_gpio_output(GPIO_LCD_ID1_, GPIO_OUT_ZERO);
	...
	static void lcm_get_params(LCM_PARAMS *params)
	{
			...
			params->dsi.lcm_esd_check_table[0].cmd = 0x80;
			params->dsi.lcm_esd_check_table[0].count = 1;
			params->dsi.lcm_esd_check_table[0].para_list[0] = 0x8b;

			params->dsi.lcm_esd_check_table[1].cmd = 0x81;
			params->dsi.lcm_esd_check_table[1].count = 1;
			params->dsi.lcm_esd_check_table[1].para_list[0] = 0xff;

			params->dsi.lcm_esd_check_table[2].cmd = 0x85;
	...
	LCM_DRIVER ek79007_wsvga_dsi_vdo_lcm_drv = {
		.name = "ek79007_wsvga_xy",
