...
#define BATTERY_ID_CHANNEL_NUM 9	//Bug-343194,sunxuebin.wt,MODIFY,20180309,for factory battery id read.
#define TOTAL_BATTERY_NUMBER 2
signed int g_battery_id_voltage[TOTAL_BATTERY_NUMBER] = {500000, 1500000};
#endif
//-Bug-343194,sunxuebin.wt,ADD,20180305,for factory battery id read.
