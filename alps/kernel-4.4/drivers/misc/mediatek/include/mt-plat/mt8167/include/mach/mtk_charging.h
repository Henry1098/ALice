...
/* charger error check */
#define BAT_LOW_TEMP_PROTECT_ENABLE    //Bug-337272,sunxuebin.wt,MODIFY,20180309,for open battery low temp protect. stop charging if temp < MIN_CHARGE_TEMPERATURE
...
#define WT_LOW_TEMP_CHARGING_CURRENT 550  /* 500 limit is 450mA *///ExtB-AQUA-811,sunxuebin.wt,MODIFY,20180409,for low temp charging current.
