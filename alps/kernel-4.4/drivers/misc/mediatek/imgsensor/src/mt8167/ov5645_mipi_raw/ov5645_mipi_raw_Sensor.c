...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		.linelength = 2844,	/* 0xb1c       //record different mode's linelength */
		.framelength = 1968,	/* 0x7b0       //record different mode's framelength */
		.startx = 0,	/* record different mode's startx of grabwindow */
		.starty = 0,	/* record different mode's starty of grabwindow */
		.grabwindow_width = 2592,	/* A20        //record different mode's width of grabwindow */
		.grabwindow_height = 1944,	/* 798      //record different mode's height of grabwindow */
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{2624, 1956, 16, 6, 2592, 1944, 2592, 1944, 0, 0, 2592, 1944, 0, 0, 2592, 1944},/* Preview */
	{2624, 1956, 16, 6, 2592, 1944, 2592, 1944, 0, 0, 2592, 1944, 0, 0, 2592, 1944},/* capture */
	{2624, 1956, 16, 6, 2592, 1944, 2592, 1944, 0, 0, 2592, 1944, 0, 0, 2592, 1944},/* video */
	{2624, 1956, 16, 6, 2592, 1944, 2592, 1944, 0, 0, 2592, 1944, 0, 0, 2592, 1944},/* hs video */
	{2624, 1956, 16, 6, 2592, 1944, 2592, 1944, 0, 0, 2592, 1944, 0, 0, 2592, 1944}	/* slim video */
};
...
static void write_shutter(kal_uint16 shutter)
{
	...
	if (imgsensor.autoflicker_en) {
		...
		if (realtime_fps >= 297 && realtime_fps <= 305)
			...
			write_cmos_sensor(0x380e, imgsensor.frame_length >> 8);	/* check */
			write_cmos_sensor(0x380f, imgsensor.frame_length & 0xFF);
		}
	} else {
		write_cmos_sensor(0x380e, imgsensor.frame_length >> 8);	/* check */
	...
	/* Update Shutter */
	write_cmos_sensor(0x3500, (shutter >> 16) & 0x0F);	/* check */
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x3503, 0x04);	/* 07 */
	...
	write_cmos_sensor(0x5180, 0xff);	/* 0x02:start setting 0x42: stop setting */
