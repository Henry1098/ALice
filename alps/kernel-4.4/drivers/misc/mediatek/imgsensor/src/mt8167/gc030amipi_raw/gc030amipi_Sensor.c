...
#define IMAGE_NO_MIRROR1 //ExtB AQUA-1459 ,caochen.wt,MDF,20180514, workaround mirror and flip sensor output data
//#define IMAGE_H_MIRROR 
//#define IMAGE_V_MIRROR 
//#define IMAGE_HV_MIRROR1

#ifdef IMAGE_NO_MIRROR1
#define MIRROR 0x54
#define STARTY 0x01
#define STARTX 0x01
#endif
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        .pclk = 23800000,                //record different mode's pclk
        .linelength = 1561,                //record different mode's linelength
    ...
    .isp_driving_current = ISP_DRIVING_2MA, //mclk driving current//6
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
			LOG_INF("yujun GC030A get_imgsensor_id i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            if (*sensor_id == imgsensor_info.sensor_id) {
                hardwareinfo_set_prop(HARDWARE_FRONT_CAM_ID, "chengxiangtong");
