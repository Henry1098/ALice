...
static imgsensor_info_struct imgsensor_info = {
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B,//sensor output first pixel color //ExtB AQUA-1459 ,caochen.wt,MDF,20180514, workaround mirror and flip sensor output data
...
static void set_dummy(void)
{
    ...
    write_cmos_sensor(0x07, imgsensor.dummy_line & 0xFF);
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
    ...
    /********************************************************
       ...
       *
       ********************************************************/
    image_mirror = IMAGE_NORMAL;  //ExtB AQUA-1459 ,caochen.wt,MDF,20180514, workaround  no mirror and flip sensor output data
    write_cmos_sensor(0xfd,0x00);
    switch (image_mirror) {
        case IMAGE_NORMAL:
