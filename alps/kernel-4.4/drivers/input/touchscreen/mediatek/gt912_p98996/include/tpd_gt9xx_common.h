...
#define GTP_REG_ESD_REF					0x81C0
#define GTP_REG_FREQA_REF					0xBE1C
#define GTP_REG_ESD_FLAG_REF   0xB4BF
...
#define GTP_CHK_FS_MNT_MAX              3
#define GTP_BAK_REF_PATH                "/sdcard/gtp_ref.bin"//"/data/gtp_ref.bin"
#define GTP_MAIN_CLK_PATH               "/sdcard/gtp_clk.bin"//"/data/gtp_clk.bin"
#define GTP_RQST_CONFIG                 0x01
#define GTP_RQST_BAK_REF                0x02
#define GTP_RQST_RESET                  0x03
#define GTP_RQST_MAIN_CLOCK             0x04
#define GTP_RQST_SAVE_REF				0x07
#define GTP_RQST_REQUEST_REF     0x08
#define GTP_RQST_EXIT_BACKUP_REF     0x09
...
#define GTP_WARP_Y_ON
#ifdef GTP_WARP_Y_ON
#define TPD_WARP_Y(y_max, y) (y_max - 1 - y)
#else
#define TPD_WARP_Y(y_max, y) y
#endif
#define GTP_LOG_SWITCH 0
/* Log define */
#define GTP_INFO(fmt, arg...)           if(GTP_LOG_SWITCH){pr_warn("<<-GTP-INFO->> "fmt"\n", ##arg);}
...
extern unsigned int lcd_product;
