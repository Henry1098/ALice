...
//Bug-343194,sunxuebin.wt,ADD,20180305,for factory battery id read.
#define HARDWARE_BATTERY_ID_GET			_IOWR(HARDWARE_ID, 0x15, char[HARDWARE_MAX_ITEM_LONGTH])
#define HARDWARE_BACK_CAM_ID_GET		_IOWR(HARDWARE_ID, 0x16, char[HARDWARE_MAX_ITEM_LONGTH])
#define HARDWARE_FRONT_CAM_ID_GET		_IOWR(HARDWARE_ID, 0x17, char[HARDWARE_MAX_ITEM_LONGTH])
...
#define HARDWARE_CHARGER_IC_INFO_GET  _IOWR(HARDWARE_ID, 0x23, char[HARDWARE_MAX_ITEM_LONGTH])
